...
#[cube]
pub fn find_nearest_fp4<F: Float>(val: F) -> u32 {
...
#[cube]
pub fn fp4_lookup<F: Float>(idx: u32) -> F {
    if idx == 0u32 {
        F::new(0.0) - F::new(1.0)
    } else if idx == 1u32 {
...
#[cube(launch)]
pub fn fp4_quantize_kernel<F: Float>(
    input: &Array<F>,
    scales: &Array<F>,
...
#[cube(launch)]
pub fn fp4_dequantize_kernel<F: Float>(
    input: &Array<u32>,
    scales: &Array<F>,
    output: &mut Array<F>,
    #[comptime] block_size: u32,
    ...
    let fp4_idx = (packed >> (sub_idx * 4u32)) & 0xFu32;
...
#[cube(launch)]
pub fn fp4_compute_scales_kernel<F: Float>(
    input: &Array<F>,
    scales: &mut Array<F>,
    #[comptime] block_size: u32,
...
#[cube(launch)]
pub fn fp4_quantize_asymmetric_kernel<F: Float>(
    input: &Array<F>,
    scales: &Array<F>,
    zero_points: &Array<F>,
    output: &mut Array<u32>,
...
#[cube(launch)]
pub fn fp4_dequantize_asymmetric_kernel<F: Float>(
    input: &Array<u32>,
    scales: &Array<F>,
    zero_points: &Array<F>,
    output: &mut Array<F>,
...
#[cube(launch)]
pub fn fp4_compute_scale_zeropoint_kernel<F: Float>(
    input: &Array<F>,
    scales: &mut Array<F>,
